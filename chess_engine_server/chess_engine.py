#!/usr/bin/python3
# -*- coding: utf-8 -*-
"""chess_engine_good.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1jGOEwODtk5RKaxrnuD3qtY3qXCtZKEkR

**Here there will be all the functions of the latest version of the chess engine**
"""
...
def load_nn():
  print("[*] Loading Keras h5 Saved Models...")
  model1 = tf.keras.models.load_model('model1.h5')
  model2 = tf.keras.models.load_model('model2.h5')
  print("[+] Keras h5 Saved Models Were Loaded Succesfully")
